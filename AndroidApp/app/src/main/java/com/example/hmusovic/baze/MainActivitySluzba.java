...
public class MainActivitySluzba extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_sluzba);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    return new TabSluzbaPocetna();
                case 1:
                    return new TabSluzbaKreirajKurs();
                case 2:
                    return new TabSluzbaKreirajKorisnika();
                case 3:
                    return new TabSluzbaKursevi();
                default:
                    return null;
            }
        }
