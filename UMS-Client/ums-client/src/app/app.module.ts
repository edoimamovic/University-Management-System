...
import { StudPredmetComponent } from './stud-predmet/stud-predmet.component';
...
const appRoutes: Routes = [
  ...
  { path: 'stud-predmet', component: StudPredmetComponent, canActivate: [AuthGuardService] },
